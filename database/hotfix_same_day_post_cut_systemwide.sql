-- ============================================================
-- HOTFIX: cortes por timestamp en todo el sistema
--
-- Problema:
-- - Un corte puede hacerse antes del cierre del dia.
-- - Despues siguen entrando tickets/premios con el mismo sale_date/draw_date.
-- - La logica actual trabaja por FECHA y considera todo ese dia como saldado.
--
-- Efecto:
-- - Las tarjetas pueden quedar en 0 aunque existan movimientos posteriores.
-- - El detalle deja fuera ventas/premios creados despues del corte.
-- - Esto afecta admin, vendedor directo, subadmin y vendedor de subadmin.
--
-- Solucion:
-- - Un ticket/premio queda cubierto por un settlement solo si:
...
--   period_end del ultimo corte, no desde period_end + 1.
--   Asi el mismo dia sigue abierto para movimientos posteriores.
--
-- Este patch redefine:
--   1. get_seller_balance
--   2. get_seller_balance_detail
--   3. create_settlement
--   4. get_seller_balance_for_seller
--   5. get_seller_balance_detail_for_seller
--   6. get_seller_balance_for_subadmin
--   7. get_seller_balance_detail_for_subadmin
